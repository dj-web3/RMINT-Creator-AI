...
export const ClockView: React.FC<ClockViewProps> = ({ stepGroups, chefPool }) => {
  ...
  return (
    <div className="flex-1 bg-[#fcfaf8] flex flex-col pt-6 relative overflow-hidden" onMouseMove={(e) => setMousePos({ x: e.clientX, y: e.clientY })}>
      <div className="w-full flex flex-col items-center px-10">
        ...
        <div className="flex items-center gap-4 mb-6 bg-slate-100 p-1.5 rounded-2xl border border-slate-200 shadow-inner">
        ...
        {clockScale === 1 && (
          <div className="w-[520px] mb-6 mt-2 animate-in fade-in slide-in-from-top-2">
        ...
        <div className="relative flex items-center justify-center" style={{ width: '476px', height: '476px' }}>
